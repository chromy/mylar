    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      <header className="bg-white border-b border-slate-200 shadow-sm">
        <div className="max-w-4xl mx-auto px-6 py-8">
          ...
          <p className="text-lg text-slate-600">Interactive code visualization for Git repositories</p>
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        <div className="bg-white rounded-xs shadow-sm border border-slate-200 p-8">
          <div className="mb-8">
            <h2 className="text-xl font-semibold text-slate-900 mb-4">Explore a Repository</h2>
          ...
          {data?.repos && data.repos.length > 0 && (
            <div>
              <h2 className="text-xl font-semibold text-slate-900 mb-4">Recent Repositories</h2>
